...
const OTPModal = ({ accountId, email }: { accountId: string; email: string }) => {
  ...
  const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      console.log("Failed to verify OTP", errorMonitor)
    }
      ...
      <AlertDialogContent className='shad-alert-dialog'>
        <AlertDialogHeader className='relative flex justify-center'>
          <AlertDialogTitle className='h2 text-center'>Enter Your OTP
            <Image src='/assets/icons/close-dark.svg' alt='logo' width={20} height={20} onClick={() => setIsOpen(false)} className='otp-close-button mr-2 mt-0' />
          </AlertDialogTitle>
        ...
        <AlertDialogFooter>
          <div className='flex w-full flex-col gap-4'>
            ...
            <div className='subtitle-2 mt-1 text-center text-light-100'>
              Didn't get a code?
